...
public class Converter {
    ...
    public static void main(String[] args) throws Exception {
        File file = new File ("C://Users//dudki//IdeaProjects//Convector//myFile2.txt");
        File file1 = new File("C://Users//dudki//IdeaProjects//Convector//myFile7.txt");
        Converter con = new Converter();
        con.convert(file, "UTF-8", file1, "cp1251");
    }
